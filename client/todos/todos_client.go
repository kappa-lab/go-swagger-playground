...
type ClientService interface {
	AddOne(params *AddOneParams, opts ...ClientOption) (*AddOneCreated, error)

	DestroyOne(params *DestroyOneParams, opts ...ClientOption) (*DestroyOneNoContent, error)

	FindTodos(params *FindTodosParams, opts ...ClientOption) (*FindTodosOK, error)
...
/*
  AddOne add one API
*/
func (a *Client) AddOne(params *AddOneParams, opts ...ClientOption) (*AddOneCreated, error) {
...
*/
func (a *Client) DestroyOne(params *DestroyOneParams, opts ...ClientOption) (*DestroyOneNoContent, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) FindTodos(params *FindTodosParams, opts ...ClientOption) (*FindTodosOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
